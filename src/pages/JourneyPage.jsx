...
const s = {
  ...
  list: { marginTop: 20 },
  row: { display: 'flex', gap: 24, padding: '24px 16px', borderTop: '1px solid #e2e0da', alignItems: 'baseline', cursor: 'default', flexWrap: 'wrap' },
  year: { fontFamily: "'JetBrains Mono', monospace", fontSize: 12, letterSpacing: '0.08em', color: '#6b6a66', width: 80, flexShrink: 0 },
  rowTitle: { fontFamily: "'Instrument Serif', serif", fontStyle: 'italic', fontSize: 24, color: '#1a1a1a', width: 260, flexShrink: 0 },
  body: { fontFamily: "'Instrument Sans', sans-serif", fontSize: 15, lineHeight: 1.6, color: '#4a4a48', flex: 1, minWidth: 0 },
};
