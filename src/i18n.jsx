...
const en = {
  ...
  journeySemesters: [
    ...
    { term: 'January 2026', sub: '(Year 1 · Term 1 · finals)', status: 'completed', title: 'Finals & First Full Year Closed',
    ...
    { term: 'February 2026', sub: '(Year 1 · Term 2 begins)', status: 'completed', title: 'NEXA Founded, C Begins',
      competitions: ['AlgoLeague Spring Camp'], hackathons: [], research: [], projects: [], achievements: ['Founded my own team, NEXA', 'Started learning C from scratch'] },
...
const tr = {
  ...
  journeySemesters: [
    ...
    { term: 'Ocak 2026', sub: '(1. Yıl · 1. Dönem · finaller)', status: 'completed', title: 'Finaller & Kapanan İlk Tam Yıl',
    ...
    { term: 'Şubat 2026', sub: '(1. Yıl · 2. Dönem başlangıcı)', status: 'completed', title: 'NEXA Kuruldu, C Başladı',
      competitions: ['AlgoLeague Bahar Kampı'], hackathons: [], research: [], projects: [], achievements: ['Kendi ekibim NEXA’yı kurdum', 'Sıfırdan C öğrenmeye başladım'] },
