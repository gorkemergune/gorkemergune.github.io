...
const en = {
  ...
  journeySemesters: [
    { term: '2024 Fall', sub: '(A2 Prep)', status: 'completed', title: 'English Prep — Foundations',
      competitions: [], hackathons: [], research: [], projects: ['First steps in Python'], achievements: ['Built an English foundation'] },
    { term: '2025 Spring', sub: '(B1 Prep)', status: 'completed', title: 'Prep — Problem Solving',
      competitions: [], hackathons: [], research: [], projects: ['Basic problem solving'], achievements: ['Daily speaking fluency', 'First look at LLM concepts'] },
    { term: '2025 Summer', sub: '(B2 Prep)', status: 'completed', title: 'Self-Study & First Builds',
      competitions: [], hackathons: [], research: [], projects: ['Synonym Master', 'Sorting Visualizer'], achievements: ['Shipped first desktop tools'] },
    { term: '2025 Fall', sub: '(Year 1 · Term 1)', status: 'completed', title: 'Computer Engineering — Year 1 Begins',
      competitions: ['IEEEXtreme', 'AlgoLeague Winter Camp'], hackathons: [], research: [], projects: ['GorkemOS', 'Space Shooter', 'Miniature Transformers'], achievements: ['Learned C & algorithms', 'Started competitive programming'] },
    { term: '2026 Spring', sub: '(Year 1 · Term 2)', status: 'completed', title: 'Hackathons & First Research',
      competitions: ['AlgoLeague Spring Camp'], hackathons: ['BTK E-Commerce Hackathon', 'Tıkla Gelsin Foodathon', 'Med-Health Early Warning'], research: ['PHQ-9 Depression Analysis'], projects: ['Find The Best', 'Face Detection', 'NEXA Website'], achievements: ['Multiple hackathons', 'Ran a live research study on stage'] },
    { term: '2026 Summer', sub: '(Current)', status: 'current', title: 'AI Products & Research',
      competitions: ['AlgoLeague Summer Camp'], hackathons: [], research: ['Email Phishing Detection'], projects: ['YOLO Custom Detector', 'Re-Minder'], achievements: ['Shipping AI products', 'Open-source momentum'] },
    ...
    { term: '2027 Fall', sub: '(Year 3 · Term 1)', status: 'locked', title: '', competitions: [], hackathons: [], research: [], projects: [], achievements: [] },
    { term: '2028 Spring', sub: '(Year 3 · Term 2)', status: 'locked', title: '', competitions: [], hackathons: [], research: [], projects: [], achievements: [] },
    { term: '2028 Summer', sub: '(Summer)', status: 'locked', title: '', competitions: [], hackathons: [], research: [], projects: [], achievements: [] },
    { term: '2028 Fall', sub: '(Year 4 · Term 1)', status: 'locked', title: '', competitions: [], hackathons: [], research: [], projects: [], achievements: [] },
    { term: '2029 Spring', sub: '(Year 4 · Term 2)', status: 'locked', title: '', competitions: [], hackathons: [], research: [], projects: [], achievements: [] },
    { term: '2029 Summer', sub: '(Graduation)', status: 'locked', title: '', competitions: [], hackathons: [], research: [], projects: [], achievements: [] },
  ],
  // Blog detail content
  blogPosts: {
    'calculus-aa': {
...
const tr = {
  ...
  journeySemesters: [
    { term: '2024 Güz', sub: '(A2 Hazırlık)', status: 'completed', title: 'İngilizce Hazırlık — Temeller',
      competitions: [], hackathons: [], research: [], projects: ['Python’a ilk adımlar'], achievements: ['İngilizce temelini kurdum'] },
    { term: '2025 Bahar', sub: '(B1 Hazırlık)', status: 'completed', title: 'Hazırlık — Problem Çözme',
      competitions: [], hackathons: [], research: [], projects: ['Temel problem çözme'], achievements: ['Günlük akıcı konuşma', 'LLM kavramlarına ilk bakış'] },
    { term: '2025 Yaz', sub: '(B2 Hazırlık)', status: 'completed', title: 'Kendi Çalışmalarım & İlk Projeler',
      competitions: [], hackathons: [], research: [], projects: ['Synonym Master', 'Sorting Visualizer'], achievements: ['İlk masaüstü araçları'] },
    { term: '2025 Güz', sub: '(1. Yıl · 1. Dönem)', status: 'completed', title: 'Bilgisayar Mühendisliği — 1. Yıl',
      competitions: ['IEEEXtreme', 'AlgoLeague Kış Kampı'], hackathons: [], research: [], projects: ['GorkemOS', 'Space Shooter', 'Miniature Transformers'], achievements: ['C ve algoritmalar', 'Competitive programming’e başlangıç'] },
    { term: '2026 Bahar', sub: '(1. Yıl · 2. Dönem)', status: 'completed', title: 'Hackathonlar & İlk Araştırma',
      competitions: ['AlgoLeague Bahar Kampı'], hackathons: ['BTK E-Ticaret Hackathon', 'Tıkla Gelsin Foodathon', 'Med-Health Erken Uyarı'], research: ['PHQ-9 Depresyon Analizi'], projects: ['Find The Best', 'Yüz Tespiti', 'NEXA Web Sitesi'], achievements: ['Birden fazla hackathon', 'Sahnede canlı araştırma çalışması'] },
    { term: '2026 Yaz', sub: '(Şu an)', status: 'current', title: 'Yapay Zekâ Ürünleri & Araştırma',
      competitions: ['AlgoLeague Yaz Kampı'], hackathons: [], research: ['E-posta Oltalama Tespiti'], projects: ['YOLO Özel Dedektör', 'Re-Minder'], achievements: ['Yapay zekâ ürünleri geliştirme', 'Açık kaynak ivmesi'] },
    ...
    { term: '2027 Güz', sub: '(3. Yıl · 1. Dönem)', status: 'locked', title: '', competitions: [], hackathons: [], research: [], projects: [], achievements: [] },
    { term: '2028 Bahar', sub: '(3. Yıl · 2. Dönem)', status: 'locked', title: '', competitions: [], hackathons: [], research: [], projects: [], achievements: [] },
    { term: '2028 Yaz', sub: '(Yaz)', status: 'locked', title: '', competitions: [], hackathons: [], research: [], projects: [], achievements: [] },
    { term: '2028 Güz', sub: '(4. Yıl · 1. Dönem)', status: 'locked', title: '', competitions: [], hackathons: [], research: [], projects: [], achievements: [] },
    { term: '2029 Bahar', sub: '(4. Yıl · 2. Dönem)', status: 'locked', title: '', competitions: [], hackathons: [], research: [], projects: [], achievements: [] },
    { term: '2029 Yaz', sub: '(Mezuniyet)', status: 'locked', title: '', competitions: [], hackathons: [], research: [], projects: [], achievements: [] },
  ],
  // Blog detail content
  blogPosts: {
    'calculus-aa': {
