...
const en = {
  ...
  introStats: [
    { n: 29, suffix: '', label: 'Projects shipped' },
    { n: 25, suffix: '+', label: 'Technologies used' },
    { n: 99, suffix: '%', label: 'Peak model F1' },
    { n: 7, suffix: '', label: 'Domains explored' },
  ],
  ...
  hallDeploy: 'DEPLOY',
  hallCollection: 'ARMOR COLLECTION',
  hallBuilds: 'BUILDS',
  hallCollectionSub: 'Every project, one workshop — drag to move through the rack.',
  hallDrag: 'DRAG',
  hallSelected: 'SELECTED',
  ...
  articlesSub: 'Papers I read and keep notes on, plus the pieces I write myself.',
  articlesTabRead: 'What I Read',
  articlesTabWritten: 'What I Write',
  articlesReadNote: 'A personal research log. The notes are what struck me while reading, not an abstract.',
  articlesWrittenNote: 'My own essays and technical write-ups.',
  articlesReadOn: 'Read',
  articlesOpenPaper: 'Open the paper',
  articlesAnnotated: 'Annotated PDF',
  articlesShowNotes: 'Reading notes',
  articlesHideNotes: 'Hide notes',
  articlesNotesKicker: 'MY READING NOTES',
  articlesBoardTitle: 'Which model was good at what',
  articlesSoonBadge: 'Coming soon',
...
const tr = {
  ...
  introStats: [
    ...
    { n: 7, suffix: '', label: 'Keşfedilen alan' },
  ],
  ...
  hallDeploy: 'BAŞLAT',
  hallCollection: 'ZIRH KOLEKSİYONU',
  hallBuilds: 'YAPIM',
  hallCollectionSub: 'Her proje, tek atölye — rafta gezinmek için sürükle.',
  hallDrag: 'SÜRÜKLE',
  hallSelected: 'SEÇİLİ',
  ...
  articlesBack: 'Ana Sayfa',
  articlesBadge: 'MAKALELER',
  articlesLabel: 'Makaleler',
  articlesSub: 'Okuyup not tuttuğum makaleler ve kendi yazdıklarım.',
  articlesTabRead: 'Okuduklarım',
  articlesTabWritten: 'Yazdıklarım',
  articlesReadNote: 'Kişisel bir araştırma günlüğü. Notlar, okurken dikkatimi çekenler; akademik özet değil.',
  articlesWrittenNote: 'Kendi yazılarım ve teknik notlarım.',
  articlesReadOn: 'Okuma',
  articlesOpenPaper: 'Makaleye git',
  articlesAnnotated: 'İşaretli PDF',
  articlesShowNotes: 'Okuma notları',
  articlesHideNotes: 'Notları gizle',
  articlesNotesKicker: 'OKUMA NOTLARIM',
  articlesBoardTitle: 'Hangi model neyde iyiydi',
  articlesSoonBadge: 'Çok yakında',
