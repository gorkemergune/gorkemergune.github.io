...
const en = {
  ...
  journeyFocus: ['AI Product Development', 'Research', 'Open Source', 'Computer Vision'],
  ...
  journeySemesters: [
    { term: '2024 Fall', status: 'completed', title: 'English Prep — Foundations',
      competitions: [], hackathons: [], research: [], projects: ['First steps in Python'], achievements: ['Built an English foundation'] },
    { term: '2025 Spring', status: 'completed', title: 'Prep — Problem Solving',
    ...
    { term: '2025 Summer', status: 'completed', title: 'Self-Study & First Builds',
      competitions: [], hackathons: [], research: [], projects: ['Synonym Master', 'Sorting Visualizer'], achievements: ['Shipped first desktop tools'] },
    { term: '2025 Fall', status: 'completed', title: 'Computer Engineering — Year 1',
      competitions: ['IEEEXtreme', 'AlgoLeague Winter Camp'], hackathons: [], research: [], projects: ['GorkemOS', 'Space Shooter'], achievements: ['Learned C & algorithms', 'Started competitive programming'] },
    { term: '2026 Spring', status: 'completed', title: 'Hackathons & First Research',
      competitions: ['AlgoLeague Spring Camp'], hackathons: ['BTK E-Commerce Hackathon', 'Tıkla Gelsin Foodathon', 'Med-Health Early Warning'], research: ['PHQ-9 Depression Analysis'], projects: ['Find The Best', 'Face Detection', 'TR–EN NMT'], achievements: ['Multiple hackathons', 'Ran a live research study on stage'] },
    { term: '2026 Summer', status: 'current', title: 'AI Products & Research',
    ...
    { term: 'Future', status: 'locked', title: 'Encrypted',
      competitions: [], hackathons: [], research: [], projects: [], achievements: [] },
  ],
  // Blog detail content
  blogPosts: {
    'calculus-aa': {
...
const tr = {
  ...
  journeyFocus: ['Yapay Zekâ Ürün Geliştirme', 'Araştırma', 'Açık Kaynak', 'Bilgisayarlı Görü'],
  journeyExpand: 'Aç',
  ...
  journeySemesters: [
    { term: '2024 Güz', status: 'completed', title: 'İngilizce Hazırlık — Temeller',
      competitions: [], hackathons: [], research: [], projects: ['Python’a ilk adımlar'], achievements: ['İngilizce temelini kurdum'] },
    { term: '2025 Bahar', status: 'completed', title: 'Hazırlık — Problem Çözme',
    ...
    { term: '2025 Yaz', status: 'completed', title: 'Kendi Çalışmalarım & İlk Projeler',
      competitions: [], hackathons: [], research: [], projects: ['Synonym Master', 'Sorting Visualizer'], achievements: ['İlk masaüstü araçları'] },
    { term: '2025 Güz', status: 'completed', title: 'Bilgisayar Mühendisliği — 1. Yıl',
      competitions: ['IEEEXtreme', 'AlgoLeague Kış Kampı'], hackathons: [], research: [], projects: ['GorkemOS', 'Space Shooter'], achievements: ['C ve algoritmalar', 'Competitive programming’e başlangıç'] },
    { term: '2026 Bahar', status: 'completed', title: 'Hackathonlar & İlk Araştırma',
      competitions: ['AlgoLeague Bahar Kampı'], hackathons: ['BTK E-Ticaret Hackathon', 'Tıkla Gelsin Foodathon', 'Med-Health Erken Uyarı'], research: ['PHQ-9 Depresyon Analizi'], projects: ['Find The Best', 'Yüz Tespiti', 'TR–EN NMT'], achievements: ['Birden fazla hackathon', 'Sahnede canlı araştırma çalışması'] },
    { term: '2026 Yaz', status: 'current', title: 'Yapay Zekâ Ürünleri & Araştırma',
    ...
    { term: 'Gelecek', status: 'locked', title: 'Şifreli',
      competitions: [], hackathons: [], research: [], projects: [], achievements: [] },
  ],
  // Blog detail content
  blogPosts: {
