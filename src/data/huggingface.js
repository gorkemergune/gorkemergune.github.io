...
const HF_ARTIFACTS = [
  {
    ...
    descTr: 'v2 asistan: Gemma-4-E4B’nin yerel düşünme ve tool calling yapan QLoRA fine-tune’u. %92 doğru-araç oranına (%17’den) ve tek, tutarlı bir öğrenilmiş kimliğe ulaşır — tek bir 12 GB GPU’da yerelde eğitildi.',
  ...
  },
  {
    ...
    descTr: 'v2 iki dilli talimat veri kümesi: persona artı ~%20 düşünme izi ve açık tool calling turları; kazınmış, elle yazılmış ve 70 sentetik gruptan tek bir derlemde birleştirildi.',
  ...
  },
  {
    ...
    descTr: 'İlk ayarlicazhocam fine-tune’unın ardındaki özgün v1 talimat veri kümesi — v2’nin düşünme/araç-çağırma yeniden inşasından önce tüm seriyi başlatan iki dilli persona derlemi (1K–10K satır).',
  ...
  },
  {
    ...
    descTr: 'v1 fine-tune’u (emekli): Llama 3.2-3B’nin LoRA/SFT’si, dürüst bir araştırma kaydı olarak tutulur — raporu, v2’nin düzelttiği chat-template uyumsuzluğunu belgeler.',
