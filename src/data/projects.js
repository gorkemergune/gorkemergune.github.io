...
const PROJECTS = [
  ...
  },
  {
    ...
    oneLiner: 'Gemini-powered price comparison across 21 marketplaces — fakes flagged, one answer.',
    oneLinerTr: '21 pazaryerinde Gemini destekli fiyat karşılaştırma — sahteler işaretli, tek cevap.',
    language: 'TypeScript',
    color: '#ff9f1c',
